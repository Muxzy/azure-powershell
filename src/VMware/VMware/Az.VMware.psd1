...
FormatsToProcess = 'VMware.Autorest/Az.VMware.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('VMware.Autorest/Az.VMware.psm1')
...
FunctionsToExport = 'Get-AzVMwareAddon', 'Get-AzVMwareAuthorization', 
               ...
               'Get-AzVMwareClusterZone', 'Get-AzVMwareDatastore', 
               'Get-AzVMwareGlobalReachConnection', 'Get-AzVMwareIscsiPath', 
               ...
               'New-AzVMwareIscsiPath', 'New-AzVMwarePlacementPolicy', 
               ...
               'Remove-AzVMwareIscsiPath', 'Remove-AzVMwarePlacementPolicy', 
               'Remove-AzVMwarePrivateCloud', 
               'Test-AzVMwareLocationQuotaAvailability', 
               'Test-AzVMwareLocationTrialAvailability', 
               'Update-AzVMwareAuthorization', 'Update-AzVMwareCloudLink', 
               'Update-AzVMwareCluster', 'Update-AzVMwareDatastore', 
               'Update-AzVMwareGlobalReachConnection', 'Update-AzVMwareIscsiPath', 
