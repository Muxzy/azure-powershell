...
RequiredAssemblies = 'SqlVirtualMachine.Autorest/bin/Az.SqlVirtualMachine.private.dll'
...
FormatsToProcess = 'SqlVirtualMachine.Autorest/Az.SqlVirtualMachine.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('SqlVirtualMachine.Autorest/Az.SqlVirtualMachine.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Assert-AzSqlVMEntraAuth', 'Get-AzAvailabilityGroupListener', 
               'Get-AzSqlVM', 'Get-AzSqlVMGroup', 'Invoke-AzRedeploySqlVM', 
               'Invoke-AzSqlVMTroubleshoot', 'New-AzAvailabilityGroupListener', 
