...
RequiredAssemblies = 'Automanage.Autorest/bin/Az.Automanage.private.dll'
...
FormatsToProcess = 'Automanage.Autorest\Az.Automanage.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('Automanage.Autorest/Az.Automanage.psm1')

# Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
FunctionsToExport = 'Get-AzAutomanageBestPractice', 'Get-AzAutomanageConfigProfile', 
               ...
               'Get-AzAutomanageHciReport', 'Get-AzAutomanageHcrpReport', 
               'Get-AzAutomanageReport', 'New-AzAutomanageConfigProfile', 
