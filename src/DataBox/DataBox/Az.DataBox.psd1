...
RequiredAssemblies = 'DataBox.Autorest/bin/Az.DataBox.private.dll'
...
FormatsToProcess = 'DataBox.Autorest/Az.DataBox.format.ps1xml'

# Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
NestedModules = @('DataBox.Autorest/Az.DataBox.psm1')
